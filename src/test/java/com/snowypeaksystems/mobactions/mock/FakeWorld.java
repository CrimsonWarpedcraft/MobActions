...
public class FakeWorld implements World {
  ...
  @Override
  public int getHighestBlockYAt(int x, int z, HeightmapType heightmap)
  ...
  @Override
  public <T extends AbstractArrow> T spawnArrow(Location location, Vector direction, float speed,
  ...
  @Override
  public boolean createExplosion(double x, double y, double z, float power, boolean setFire,
                                 boolean breakBlocks, Entity source) {
    return false;
  }
  ...
  @Override
  public <T> void spawnParticle(Particle particle, List<Player> receivers, Player source, double x,
                                double y, double z, int count, double offsetX, double offsetY,
