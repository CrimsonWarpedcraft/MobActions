...
/**
 * Implementation of EventForceStartCommand.
 *
 * @author Copyright (c) Levi Muniz. All Rights Reserved.
 */
public class EventForceStartCommandImpl implements EventForceStartCommand {
  private final String name;
  private final MobEventManager manager;

  public EventForceStartCommandImpl(String name, MobEventManager manager) {
    this.name = name;
